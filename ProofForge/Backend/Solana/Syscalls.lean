...
def sol_get_epoch_rewards_sysvar : String := "sol_get_epoch_rewards_sysvar"
def sol_get_last_restart_slot : String := "sol_get_last_restart_slot"
def sol_get_sysvar          : String := "sol_get_sysvar"
