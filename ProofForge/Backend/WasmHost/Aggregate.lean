...
namespace ProofForge.Backend.WasmHost.Aggregate
...
mutual
  ...
  partial def collectArrayLitsExpr (e : Expr) : Array (ValueType × Nat) :=
    ...
    | .crosscallAbiPacked target _ _ _ _ _ _ => collectArrayLitsExpr target
    | .nativeValue => #[]
  ...
  partial def collectStructLitsExpr (e : Expr) : Array String :=
    ...
    | .crosscallAbiPacked target _ _ _ _ _ _ => collectStructLitsExpr target
