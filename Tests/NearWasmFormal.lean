...
#check ProofForge.Backend.WasmHost.Refinement.counter_ir_observable_trace_ok
#check ProofForge.Backend.WasmHost.Refinement.counter_emitwat_exports_trace_entrypoints
#check ProofForge.Backend.WasmHost.Refinement.counter_emitwat_artifact_surface_ok
#check ProofForge.Backend.WasmHost.Refinement.counter_emitwat_host_import_signatures_ok
#check ProofForge.Backend.WasmHost.Refinement.counter_emitwat_host_frames_ok
#check ProofForge.Backend.WasmHost.Refinement.counter_emitwat_input_host_frames_ok
#check ProofForge.Backend.WasmHost.Refinement.counter_emitwat_storage_read_key_frames_ok
#check ProofForge.Backend.WasmHost.Refinement.counter_emitwat_storage_write_key_value_frames_ok
...
#check ProofForge.Backend.WasmHost.Refinement.counter_wasm_increment_after_initialize_step_simulation_ok
#check ProofForge.Backend.WasmHost.Refinement.counter_wasm_get_after_increment_step_simulation_ok
#check ProofForge.Backend.WasmHost.Refinement.counter_wasm_initialize_step_simulation_sound_checked
#check ProofForge.Backend.WasmHost.Refinement.counter_wasm_get_after_initialize_step_simulation_sound_checked
#check ProofForge.Backend.WasmHost.Refinement.counter_wasm_increment_after_initialize_step_simulation_sound_checked
...
#check ProofForge.Backend.WasmHost.Refinement.value_vault_emitwat_artifact_surface_ok
#check ProofForge.Backend.WasmHost.Refinement.value_vault_emitwat_host_import_signatures_ok
#check ProofForge.Backend.WasmHost.Refinement.value_vault_emitwat_host_frames_ok
#check ProofForge.Backend.WasmHost.Refinement.value_vault_emitwat_input_host_frames_ok
#check ProofForge.Backend.WasmHost.Refinement.value_vault_emitwat_context_host_frames_ok
#check ProofForge.Backend.WasmHost.Refinement.value_vault_emitwat_storage_read_key_frames_ok
#check ProofForge.Backend.WasmHost.Refinement.value_vault_emitwat_storage_write_key_value_frames_ok
#check ProofForge.Backend.WasmHost.Refinement.value_vault_emitwat_memory_surface_ok
#check ProofForge.Backend.WasmHost.Refinement.value_vault_ir_observable_trace_ok
#check ProofForge.Backend.WasmHost.Refinement.value_vault_wasm_executable_trace_ok
#check ProofForge.Backend.WasmHost.Refinement.array_storage_ir_observable_trace_ok
#check ProofForge.Backend.WasmHost.Refinement.array_storage_wasm_executable_trace_ok
#check ProofForge.Backend.WasmHost.Refinement.map_storage_ir_observable_trace_ok
#check ProofForge.Backend.WasmHost.Refinement.map_storage_wasm_executable_trace_ok
#check ProofForge.Backend.WasmHost.Refinement.value_vault_emitwat_offline_host_execution_surface_ok
#check ProofForge.Backend.WasmHost.Refinement.value_vault_emitwat_offline_host_return_payload_hex_ok
#check ProofForge.Backend.WasmHost.Refinement.value_vault_emitwat_offline_host_storage_snapshots_ok
#check ProofForge.Backend.WasmHost.Refinement.value_vault_emitwat_offline_host_storage_hex_snapshots_ok
#check ProofForge.Backend.WasmHost.Refinement.value_vault_offline_host_final_state_derives_from_invariant
#check ProofForge.Backend.WasmHost.Refinement.value_vault_offline_host_logs_derive_from_invariant_state
#check ProofForge.Backend.WasmHost.Refinement.value_vault_offline_host_log_payload_hex_derives_from_invariant_state
#check ProofForge.Backend.WasmHost.Refinement.value_vault_offline_host_return_payload_hex_derives_from_invariant_returns
#check ProofForge.Backend.WasmHost.Refinement.value_vault_emitwat_offline_host_log_payload_hex_ok
#check ProofForge.Backend.WasmHost.Refinement.value_vault_emitwat_backend_invariant_bridge_ok
