...
namespace Tests.Quint.ArrayPathReplay
...
def main : IO UInt32 := do
  let qntPath := "build/quint/ArrayPathReplay.qnt"
  let itfPath := "build/quint/ArrayPathReplay.itf.json"
  ...
  | .error err =>
      ...
      return 1
  | .ok trace =>
      match Replay.replayTrace ProofForge.IR.Examples.EvmStorageArrayProbe.emitQuintPathModule trace with
      | .error err =>
...
end Tests.Quint.ArrayPathReplay

def main : IO UInt32 := Tests.Quint.ArrayPathReplay.main