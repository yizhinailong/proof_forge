...
namespace Tests.Quint.AssignmentReplay
...
def main : IO UInt32 := do
  let qntPath := "build/quint/AssignmentReplay.qnt"
  let itfPath := "build/quint/AssignmentReplay.itf.json"
  ...
  | .error err =>
      ...
      return 1
  | .ok trace =>
      match Replay.replayTrace ProofForge.IR.Examples.AssignmentProbe.module trace with
      | .error err =>
...
end Tests.Quint.AssignmentReplay

def main : IO UInt32 := Tests.Quint.AssignmentReplay.main