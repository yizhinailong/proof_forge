...
namespace Tests.Quint.ConditionalReplay
...
def main : IO UInt32 := do
  let qntPath := "build/quint/ConditionalReplay.qnt"
  let itfPath := "build/quint/ConditionalReplay.itf.json"
  ...
  | .error err =>
      ...
      return 1
  | .ok trace =>
      match Replay.replayTrace ProofForge.IR.Examples.ConditionalProbe.module trace with
      | .error err =>
...
end Tests.Quint.ConditionalReplay

def main : IO UInt32 := Tests.Quint.ConditionalReplay.main