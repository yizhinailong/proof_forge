...
namespace Tests.Quint.LoopReplay
...
def main : IO UInt32 := do
  let qntPath := "build/quint/LoopReplay.qnt"
  let itfPath := "build/quint/LoopReplay.itf.json"
  ...
  | .error err =>
      ...
      return 1
  | .ok trace =>
      match Replay.replayTrace ProofForge.IR.Examples.LoopProbe.module trace with
      | .error err =>
...
end Tests.Quint.LoopReplay

def main : IO UInt32 := Tests.Quint.LoopReplay.main