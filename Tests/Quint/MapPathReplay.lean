...
namespace Tests.Quint.MapPathReplay
...
def main : IO UInt32 := do
  let qntPath := "build/quint/MapPathReplay.qnt"
  let itfPath := "build/quint/MapPathReplay.itf.json"
  ...
  | .error err =>
      ...
      return 1
  | .ok trace =>
      match Replay.replayTrace ProofForge.IR.Examples.MapProbe.emitQuintPathModule trace with
      | .error err =>
...
end Tests.Quint.MapPathReplay

def main : IO UInt32 := Tests.Quint.MapPathReplay.main