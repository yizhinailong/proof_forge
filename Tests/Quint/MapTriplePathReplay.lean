...
namespace Tests.Quint.MapTriplePathReplay
...
def main : IO UInt32 := do
  let qntPath := "build/quint/MapTriplePathReplay.qnt"
  let itfPath := "build/quint/MapTriplePathReplay.itf.json"
  ...
  | .error err =>
      ...
      return 1
  | .ok trace =>
      match Replay.replayTrace ProofForge.IR.Examples.MapProbe.emitQuintTriplePathModule trace with
      | .error err =>
...
end Tests.Quint.MapTriplePathReplay

def main : IO UInt32 := Tests.Quint.MapTriplePathReplay.main