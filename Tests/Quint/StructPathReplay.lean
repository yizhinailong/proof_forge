...
namespace Tests.Quint.StructPathReplay
...
def main : IO UInt32 := do
  let qntPath := "build/quint/StructPathReplay.qnt"
  let itfPath := "build/quint/StructPathReplay.itf.json"
  ...
  | .error err =>
      ...
      return 1
  | .ok trace =>
      match Replay.replayTrace ProofForge.IR.Examples.EvmStorageStructProbe.emitQuintPathModule trace with
      | .error err =>
...
end Tests.Quint.StructPathReplay

def main : IO UInt32 := Tests.Quint.StructPathReplay.main