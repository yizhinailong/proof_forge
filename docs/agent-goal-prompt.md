...
batch2 done; Solana ELF done. PF-P2-03 in progress: EVM+Solana real peer
(call_with_args → 49 via Foundry/revm + Mollusk CPI) done; NEAR real peer still
blocked (no near CLI/sandbox).
...
| 3 | PF-P2-03 | in_progress: EVM revm+Foundry + Solana Mollusk peer (call_with_args→49) done; next: NEAR real peer (blocked: no near/near-sandbox/cargo-near) | Waves 1 and 2 done |
