...
Baseline: Waves 0–2 done. Wave 3: PF-P2-01 done. PF-P2-02 in progress: Counter/
ValueVault testkit now execute source-built Solana ELF; remaining EVM custom-
error/ERC721 receiver/ERC1155 batch and NEAR sandbox/Promise.
...
| 3 | PF-P2-02 | in_progress: Solana source-ELF in testkit for Counter/ValueVault; next: EVM custom-error ABI + ERC721 receiver or ERC1155 batch Foundry cases | Waves 1 and 2 done; complete one backend slice at a time |
