...
| 1 | PF-P1-03 | in_progress: schema + EmitWat + Solana source-asm bundles; next: EVM metadata writer + remaining Solana ELF/fixture paths | PF-P1-01 and PF-P1-02 done |
