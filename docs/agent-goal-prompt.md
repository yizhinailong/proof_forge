...
Baseline: Waves 0–2 done. Wave 3: PF-P2-01 product catalog + ExternalVault in matrix;
remaining: triad runtime scenarios by capability family + --deny-skip CI policy.
...
| 3 | PF-P2-01 | in_progress: catalog + ExternalVault matrix + testkit --deny-skip; next: more capability-family triad runtime scenarios | Waves 1 and 2 done |
