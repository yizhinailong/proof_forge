...
| 3 | PF-P2-02 | in_progress: Solana source-ELF testkit + EVM custom-error selector Foundry; next: ERC721 receiver / ERC1155 batch / NEAR sandbox | Waves 1 and 2 done; complete one backend slice at a time |
