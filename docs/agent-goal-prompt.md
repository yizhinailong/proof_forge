...
Baseline: Wave 1 complete (PF-P1-01..04). Wave 2: PF-P1-05 DSL version + 5-param
entries + throwErrorAt diagnostics; remaining: isolate Solana Surface from Source.lean.
...
| 2 | PF-P1-05 | in_progress: dsl v1 + 5-param entry + located diagnostics; next: remove Solana.Surface import from Source.lean | Wave 1 done |
