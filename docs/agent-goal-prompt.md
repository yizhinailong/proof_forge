...
| 5 | PF-P3-01 | in_progress: `m = counterShapeModule m.name` + `∀ m lowerable → lowerModule (withCanonical m) = .ok`; next: free-name `∀ m lowerable → lowerModule m = .ok` (isOk name-independence) | Wave 3 done; after PF-P3-02 |
