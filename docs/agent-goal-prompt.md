...
Baseline: Waves 0–3 done. Wave 4: PF-P3-02 in progress — Soroban, CosmWasm, Aptos, Sui,
Cloudflare Counter six-gates; next Psy then Aleo.
...
| 4 | PF-P3-02 | in_progress: Soroban+CosmWasm+Aptos+Sui+Cloudflare Counter six-gate; next Psy, Aleo | Wave 3 done; promote only one target at a time, and do not block Wave 5 |
