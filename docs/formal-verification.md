...
4. FV-4 backend trace obligations: scalar EVM IR traces are done for
   ...
   obligations; next, connect those surfaces toward offline-host execution
   obligations.
