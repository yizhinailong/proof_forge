...
- Done for EVM: add an Anvil deploy smoke that sends generated Counter
  ...
  the receipt/deployed address/runtime-code match and transaction input
  initcode, and exercises the Counter lifecycle over JSON-RPC.
...
- Local Anvil deployment can consume the generated deploy manifest and initcode,
  ...
  JSON and validates that its input equals the generated initcode.
