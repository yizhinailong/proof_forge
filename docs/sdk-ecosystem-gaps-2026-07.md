...
| ERC-4626 (vault standard) | Partial | **Call** peer: `IERC4626` / `external_vault`. **Deploy body:** `Stdlib.ERC4626` **pro-rata** + **entry feeBps** + `preview*` + IERC20 pull/push (`just product-erc4626-vault`). Exit fees / fee-on-transfer / asymmetric mint-preview still open | P1 |
