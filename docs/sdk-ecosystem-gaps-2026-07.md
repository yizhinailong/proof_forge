...
| ERC-4626 (vault standard) | Partial | **Call** peer: `IERC4626` / `external_vault`. **Deploy body:** `Stdlib.ERC4626` **pro-rata** + **entry/exit feeBps** + net `mint`/`preview*` + IERC20 pull/push (`just product-erc4626-vault`). Fee-on-transfer assets still open | P1 |
