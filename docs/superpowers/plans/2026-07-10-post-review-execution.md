...
| E1 | in_progress: E1.1 validated static-constant slice landed; runtime typed args remain | errors-ir-smoke selector + words; fail-closed diagnostics; schema-only metadata + client payload decode |
| L1 | pending | |
