...
Rust/Pinocchio programs for the same account schema. The System transfer and
SPL Token `transfer_checked` reference contracts are the first static
equivalence anchors for that line, and the System transfer live harness is
