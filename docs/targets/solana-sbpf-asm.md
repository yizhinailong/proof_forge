...
are the first static equivalence anchors for that line, and their live
dual-deploy harnesses are already wired to build/deploy both ELFs when Solana
rustc is available. The
