...
子集，以及第一批 Solana target-extension form：account、PDA derivation 和
...
1. 将 Learn parser 从当前 Vault-level Solana 子集扩展到 System Program
   transfer/create-account、Token-2022、sysvar、log、memory、crypto 和
   return-data helper。
