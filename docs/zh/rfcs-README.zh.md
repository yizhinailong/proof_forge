...
| [0004](0004-solana-sbpf-assembly-backend.md) | Accepted | Solana sBPF assembly 后端，即绕过 Zig runtime 的 direct codegen 路线 |
| [0005](0005-multichain-token-sdk.md) | Draft | 多链 Token SDK：EVM 上生成 ERC-20，Solana 上生成 SPL Token / Token-2022 计划 |
