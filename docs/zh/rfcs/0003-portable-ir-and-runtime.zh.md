...
| 领域 | 权威依据 | 本 RFC 的角色 |
|---|---|---|
| Contract Intent API 和 IR 单元结构 | [`portable-ir.md`](../portable-ir.md) | 使用它；在 `Effect` 之上添加 target intent resolution 和 capability 降级规则 |
...
| 已定决策 | [`decisions.md`](../decisions.md) | 继承选定决策；见下文 |
