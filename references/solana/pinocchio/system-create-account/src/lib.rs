...
pub const PF_MIN_INSTRUCTION_DATA_LEN: usize = 17;
pub const PF_LAMPORTS_OFFSET: usize = 1;
pub const PF_LAMPORTS_SIZE: usize = 8;
pub const PF_SPACE_OFFSET: usize = 9;
pub const PF_SPACE_SIZE: usize = 8;
pub const PF_STATE_ACCOUNT_INDEX: usize = 0;
pub const PF_PAYER_ACCOUNT_INDEX: usize = 1;
pub const PF_NEW_ACCOUNT_INDEX: usize = 2;
pub const PF_SYSTEM_PROGRAM_ACCOUNT_INDEX: usize = 3;
pub const PF_ACCOUNT_COUNT: usize = 4;
pub const PF_SYSTEM_CREATE_ACCOUNT_DISCRIMINATOR: u32 = 0;
pub const PF_SYSTEM_CREATE_ACCOUNT_DATA_LEN: usize = 52;
pub const PF_STATE_LAMPORTS_WRITE_OFFSET: usize = 0;
pub const PF_STATE_SPACE_WRITE_OFFSET: usize = 8;
...
pub fn process_instruction(
    ...
    if !accounts[PF_STATE_ACCOUNT_INDEX].is_writable()
        ...
        || !accounts[PF_NEW_ACCOUNT_INDEX].is_writable()
    {
        return Err(ProgramError::InvalidArgument);
    }
    if !accounts[PF_PAYER_ACCOUNT_INDEX].is_signer()
        || !accounts[PF_NEW_ACCOUNT_INDEX].is_signer()
    {
    ...
    let space = u64::from_le_bytes(
        instruction_data[PF_SPACE_OFFSET..PF_SPACE_OFFSET + PF_SPACE_SIZE]
            .try_into()
            .map_err(|_| ProgramError::InvalidInstructionData)?,
    );
    ...
    let new_account = &cpi_accounts[1];
    ...
    if state_data.len() < PF_STATE_SPACE_WRITE_OFFSET + PF_STATE_WRITE_SIZE {
        return Err(ProgramError::AccountDataTooSmall);
    }
    state_data[PF_STATE_LAMPORTS_WRITE_OFFSET..PF_STATE_LAMPORTS_WRITE_OFFSET + PF_STATE_WRITE_SIZE]
        .copy_from_slice(&lamports.to_le_bytes());
    state_data[PF_STATE_SPACE_WRITE_OFFSET..PF_STATE_SPACE_WRITE_OFFSET + PF_STATE_WRITE_SIZE]
