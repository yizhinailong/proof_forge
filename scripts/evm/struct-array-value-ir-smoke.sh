...
GOLDEN_FILE="${IR_EVM_GOLDEN:-$ROOT/Examples/Evm/EvmStructArrayValueProbe.golden.yul}"
...
"$ROOT/.lake/build/bin/proof-forge" --emit-evm-struct-array-value-ir-bytecode \
