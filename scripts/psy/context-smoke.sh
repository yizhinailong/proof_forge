...
GOLDEN_FILE="${PSY_GOLDEN:-$ROOT/Examples/Backend/Psy/ContextProbe.golden.psy}"
...
lake env lean --run "$ROOT/Tests/PsyMetadataExport.lean" ContextProbe > "$PLAN_METADATA_FILE"
