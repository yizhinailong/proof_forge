...
GOLDEN_FILE="${PSY_GOLDEN:-$ROOT/Examples/Psy/U32HashPackingProbe.golden.psy}"
...
"$ROOT/.lake/build/bin/proof-forge" --emit-u32-hash-packing-ir-psy -o "$PSY_FILE"
...
[package]
name = "proof_forge_u32_hash_packing"
version = "0.1.0"
type = "bin"
